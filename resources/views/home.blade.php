    ...
    <div class="container-fluid pt-5">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img class="card-img-top mb-2" src="{{url('img/class-3.jpg')}}" alt="" />
              <div class="card-body text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            ...
            >
              <img class="img-fluid w-100" src="{{url('img/team-1.jpg')}}" alt="" />
              <div
          ...
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            <div
              ...
              style="border-radius: 100%"
            >
              <img class="img-fluid w-100" src="{{url('img/team-2.jpg')}}" alt="" />
              <div
                class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute"
              >
                <a
          ...
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            <div
              ...
              style="border-radius: 100%"
            >
              <img class="img-fluid w-100" src="{{url('img/team-3.jpg')}}" alt="" />
              <div
                class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute"
              >
                <a
          ...
          <div class="col-md-6 col-lg-3 text-center team mb-5">
            <div
              ...
              style="border-radius: 100%"
            >
              <img class="img-fluid w-100" src="{{url('img/team-4.jpg')}}" alt="" />
              <div
                class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute"
              >
                <a
