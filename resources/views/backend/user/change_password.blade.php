          ...
          <div class="card-body">
            ...
            <form class="row g-3" action="" method="post">
              ...
              <div class="col-12">
                ...
                <input type="password" name="old_password"  required class="form-control" id="inputNanme4">
                
              </div>
              <div class="col-12">
                <label for="inputEmail4" class="form-label">New Password</label>
                <input type="password" name="new_password"  required class="form-control" id="inputEmail4">
